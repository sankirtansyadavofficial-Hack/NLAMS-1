              ...
              <div className="pt-6 border-t border-white/5">
                ...
                <div className="p-6 rounded-2xl bg-white/[0.02] border border-dashed border-white/20 text-center">
                  ...
                  <div className="mt-4 relative inline-block">
                    <button type="button" className="px-4 py-2 rounded-xl bg-white/10 text-xs font-semibold text-white hover:bg-white/20 transition-all pointer-events-none">
                      Browse Files {formData.documentsAttached > 0 ? `(${formData.documentsAttached} files selected)` : ''}
                    </button>
                    <input 
                      type="file" 
                      multiple 
                      ...
                      onChange={(e) => setFormData({ ...formData, documentsAttached: e.target.files.length })}
                    />
                  </div>
                </div>
              </div>
